package pe.edu.tecsup.lab04.prj_crud_spring_boot.aop;
...
import pe.edu.tecsup.lab04.prj_crud_spring_boot.domain.persistence.AuditoriaDao;
...
public class LogginAspecto {
    ...
    @Around("execution(* pe.edu.tecsup.lab04.prj_crud_spring_boot.services.*ServiceImpl.*(..))")
    ...
    @After("execution(* pe.edu.tecsup.lab04.prj_crud_spring_boot.*Controller.guardar*(..)) ||" +
            "execution(* pe.edu.tecsup.lab04.prj_crud_spring_boot.*Controller.editar*(..)) ||" +
            "execution(* pe.edu.tecsup.lab04.prj_crud_spring_boot.*Controller.eliminar*(..))")
